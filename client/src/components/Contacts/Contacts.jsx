    ...
    return (
        ...
        <div class="container">
            <div class="contacts-title">
                <p class="contacts-intro">Контакти</p>
                <hr/>
            </div>
            <div class="InformationAndMap">
                <div class="InformationAndMapWrapper">
                    <div class="contacts-Information">
                        <p class="contacts-Information-title">Адреса навчального закладу:</p>
                        <div class="contacts-Information-intros">
                            <div class="firstintro">
                                ...
                                <span class="phones-info">+380-352-28-19-66; 28-18-11; 28-19-36</span> <br/>
                                cs@tk.te.ua
                            </div>
                            <div class="secondintro">
                                ...
                                <span class="phones-info"> 26-95-34;   26-91-32;   26-90-39</span>
                            </div>
                        </div>
                    </div>
                    <div class="map">
