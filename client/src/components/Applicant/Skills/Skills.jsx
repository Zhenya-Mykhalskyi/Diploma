        ...
        <section className="skills">
            <div className="container">
                <div className="skills-content">
                    <img src="Images/ApplicantImages/neartextphoto.png" className="skills-img" alt="" />
                    <p className="skills-text">
                        ...
                        <p className="botton-text"><b>Випускники коледжу за даною спеціальністю отримують атестат про середню освіту, робітничу кваліфікацію за професією “Оператор комп'ютерного набору” та диплом молодшого спеціаліста – техніка-програміста.</b></p>
                    </p>
                </div>
            </div>
        </section>
